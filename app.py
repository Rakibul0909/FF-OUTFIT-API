...
def outfit_image():
    ...
    profile_info = player_data.get("profileInfo") or {}
    ...
    required_starts = ["211", "214", "203", "204", "205", "208"]
    fallback_ids = ["211000000", "214000000", "203000000",
                    "204000000", "205000000", "208000000"]
    ...
    def fetch_outfit_image(idx, code):
        ...
        for oid in outfit_ids:
            ...
            if str_oid.startswith(code) and str_oid not in used_ids:
                ...
                break
        if matched is None:
            matched = fallback_ids[idx] if idx < len(fallback_ids) else fallback_ids[0]
